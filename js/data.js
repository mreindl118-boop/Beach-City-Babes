...
export const INTIMATE_DATES = [
  { id: 'sensual', name: 'Sensual Night In', emoji: '🕯️', minTier: 2, hours: 3, pub: 0.05,
    ...
    scene: 'Candlelight, a shared bottle, {pos} mouth finding yours before the second glass is poured. Clothes get lazy, hands get bold, and the rest melts into a warm, breathless, knowing dark.' },
  { id: 'massage', name: 'Oil Massage', emoji: '💆', minTier: 2, hours: 2, pub: 0.05,
    aff: 10, des: 30, rep: 1, intimate: true, needs: 'spice',
    desc: 'Warm oil, low light, wandering hands. Needs an Afterglow item.',
    scene: 'Warm oil, low light, and {pos} hands mapping every knot out of you — until the massage stops being about knots at all. Fade to a slow, glowing dark.' },
  { id: 'toybox', name: 'Toy Box Night', emoji: '🔮', minTier: 2, hours: 3, pub: 0.05,
    ...
    scene: 'You unwrap your little surprise. {name}’s eyebrows climb, then their smile does — then their breath. They pull you down by the collar and the lights go out for a very good while.' },
  { id: 'shower', name: 'Steam & Suds', emoji: '🚿', minTier: 3, hours: 2, pub: 0.05,
    aff: 8, des: 40, rep: 1, intimate: true,
    desc: 'Hot water, fogged glass, no personal space. Lovers only.',
    scene: 'Hot water, fogged glass, and absolutely no interest in staying on your own side of it. {sub} pulls you under the spray, and steam hides the rest.' },
  { id: 'kink', name: 'Kink Night', emoji: '🎀', minTier: 3, hours: 3, pub: 0.05,
    ...
    scene: 'Rules set, safeword agreed, blindfold snug. {sub} takes their time making you wait, making you ask — and what happens after is between you two and the dark.' },
  { id: 'bondage', name: 'Ropes & Restraints', emoji: '⛓️', minTier: 3, hours: 3, pub: 0.05,
    aff: 8, des: 46, rep: 2, intimate: true, needs: 'kink',
    desc: 'Cuffs, a ball gag, a safe-signal you both agree on. Deep trust — Lovers only.',
    scene: 'Limits talked through, safe-signal set — a tap, since the gag means no safeword. Wrists cuffed, buckle snug, {sub} circling you slow, savoring how much you trust them. Then the lights drop and the rest stays behind the locked door.' },
  { id: 'orgy', name: 'Playroom Party', emoji: '🎭', minTier: 3, hours: 4, pub: 0.35,
    ...
    scene: 'The whole honest, tangled, laughing lot of you behind one very locked door — hands everywhere, nobody keeping count. The night belongs to nobody and everybody.' },
];
