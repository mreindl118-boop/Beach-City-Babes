...
// mx,my are the marker's position on the illustrated map (viewBox 0 0 320 240).
export const LOCATIONS = [
  { id: 'beach',    name: 'The Beach',       emoji: '🏖️', mx: 52,  my: 86,  kind: 'sand',
  ...
  { id: 'market',   name: 'Night Market',    emoji: '🏮', mx: 232, my: 158, kind: 'fun',
    open: ['evening', 'night'], vibe: 'lantern light and street food',
    jobs: ['pastry chef'], acts: ['sushi'] },
  { id: 'club',     name: 'Neon Club',       emoji: '💃', mx: 108, my: 186, kind: 'club',
    open: ['night', 'late'], vibe: 'bass you feel in your teeth',
    jobs: ['DJ'], acts: ['dance'] },
  { id: 'shop',     name: 'Afterglow',       emoji: '🔞', mx: 186, my: 200, kind: 'club',
    open: ['evening', 'night', 'late'], vibe: 'velvet ropes and no judgment', adult: true },
  { id: 'clinic',   name: 'Bay Clinic',      emoji: '🏥', mx: 280, my: 196, kind: 'shop',
    open: ['morning', 'afternoon'], vibe: 'clean, kind, confidential', clinic: true },
  { id: 'home',     name: 'Your Place',      emoji: '🏠', mx: 44,  my: 206, kind: 'home',
